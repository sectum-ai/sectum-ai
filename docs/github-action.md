...
> (`sectum-ai/sectum-ai@v0.1.8`) or a commit SHA for reproducible runs; `@main`
> tracks the latest.
...
|---|---|---|
| `version` | `0.1.8` | `sectum-ai` version to install from PyPI. Pin for reproducibility; leave empty for the latest release. |
