...
> adapters for vector stores, caches, observability, and RAG), the probe
> interface, the full Class 1–11 attack catalog, the tamper-evident evidence
> chain, the regression-baseline engine, the `sectum` CLI, a mkdocs
